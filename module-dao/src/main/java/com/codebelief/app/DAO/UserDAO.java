...
public class UserDAO implements IUserDAO{
	...
	public boolean doInsert(User user) throws Exception {
		//java.sql.Date time=new java.sql.Date(user.getPushTime().getTime());
	...
	public LinkedList<String> doFindPasswordAndEmail(String UserName) throws Exception {
		...
		stat=(Statement) conn.createStatement();
		ResultSet rs=stat.executeQuery(query);
		LinkedList<String> answer=new LinkedList<>();	//contain the Password and Email
		while(rs.next()){
